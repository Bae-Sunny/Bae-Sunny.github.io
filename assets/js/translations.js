const translations = {
    'ko': {
        ...
        'project1_desc': 'KBO 리그의 다양한 데이터를 수집-통합-분석하여 사용자에게 가치 있는 정보를 제공하는 플랫폼입니다.',
        ...
        'project7_tag': 'AI 기획',
        'project7_desc': 'GPT를 활용한 AI 챗봇으로 보이스피싱 대응 시뮬레이션 훈련 서비스를 기획했으며,실무 수준의 시나리오 설계와 응답 전략을 구조화했습니다.',
        'project8_title': '🛍️ 스마트스토어 FAQ 기반 RAG 챗봇',
        'project8_tag': '풀스택 AI',
        'project8_desc': 'OpenAI GPT와 ChromaDB를 활용해 FAQ 데이터를 질의응답 형태로 제공하는 벡터 검색 기반 챗봇 플랫폼을 개발했으며, Django와 Docker 환경에서 통합 구성했습니다.',
        'project_demo': '상세보기',
    ...
    'en': {
        ...
        'project1_desc': 'A platform that collects, integrates, and analyzes diverse KBO league data to provide valuable insights to users.',
        ...
        'project7_desc': 'Planned a voice phishing response training service powered by a GPT-based AI chatbot, and structured realistic conversation scenarios and response strategies reflecting real-world conditions.',
        'project8_title': '🛍️ Smartstore FAQ-based RAG Chatbot',
        'project8_tag': 'Full-Stack AI',
        'project8_desc': 'Developed a vector search-based chatbot platform that delivers FAQ responses using OpenAI GPT and ChromaDB, integrated into a full-stack system with Django and Docker.',
    ...
    'ja': {
        ...
        'project1_desc': 'KBOリーグの多様なデータを収集・統合・分析し、ユーザーに価値ある情報を提供するプラットフォームです。',
        ...
        'project7_tag': 'AIプラン',
        'project7_desc': 'GPTを活用したAIチャットボットによるボイスフィッシング対策シミュレーション訓練サービスを企画し、実務レベルのシナリオ設計と応答戦略の構築を行いました。',
        'project8_title': '🛍️ Smartstore FAQベースRAGチャットボット',
        'project8_tag': 'フルスタック AI',
        'project8_desc': 'OpenAI GPTとChromaDBを活用し、FAQに対する応答を提供するベクトル検索型チャットボットプラットフォームを開発し、DjangoとDockerを用いてフルスタック環境に統合しました。',
        'project_demo': '詳細',
        'project_github': 'GitHub',
        'project_ppt': '発表資料',
        'skills_title': '技術スタック',
    ...
    'zh': {
        ...
        'project1_tag': '数据平台',
        'project1_desc': '收集、整合、分析KBO联赛的各种数据，为用户提供有价值信息的平台。',
        ...
        'project7_tag': 'AI 规划',
        'project7_desc': '策划了一项基于GPT的AI聊天机器人用于语音钓鱼应对训练的服务，并设计了贴近实际业务的对话场景与应答策略体系。',
        'project8_title': '🛍️ Smartstore FAQベースRAGチャットボット',
        'project8_tag': '全栈 AI',
        'project8_desc': '开发了一个基于向量检索的聊天机器人平台，利用OpenAI GPT和ChromaDB实现FAQ问答服务，并通过Django和 Docker实现了全栈系统集成。',
        'project_demo': '详情',
        'project_github': 'GitHub',
        'project_ppt': '演示文稿',
        'skills_title': '技术栈',
