const translations = {
    'ko': {
        ...
        'project7_tag': 'AI 기획',
        'project7_desc': 'AI 챗봇을 활용한 보이스피싱 대응 시뮬레이션 훈련 서비스 기획안. 실무 수준의 시나리오 구성과 GPT 활용 전략을 담았습니다.',
        'project_demo': '상세보기',
    ...
    'en': {
        ...
        'project7_desc': 'A service planning project for voice phishing response training using an AI chatbot. It includes scenario design and strategic use of GPT in practice.',
    ...
    'ja': {
        ...
        'project7_tag': 'AIプラン',
        'project7_desc': 'AIチャットボットを活用した振り込め詐欺対策シミュレーショントレーニングサービス企画案。実務レベルのシナリオ構成とGPT活用戦略を盛り込んでいます。',
        'project_demo': '詳細',
        'project_github': 'GitHub',
        'project_ppt': '発表資料',
        'skills_title': '技術スタック',
    ...
    'zh': {
        ...
        'project7_tag': 'AI 规划',
        'project7_desc': '一个利用AI聊天机器人进行语音诈骗应对模拟训练的服务规划项目，包含实战级场景设计和GPT应用策略。',
        'project_demo': '详情',
        'project_github': 'GitHub',
        'project_ppt': '演示文稿',
        'skills_title': '技术栈',
